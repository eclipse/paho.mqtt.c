...
MBEDTLS_ROOT_DIR | "" (system default) | Directory containing your mbedTLS installation (i.e. `/usr/local` when headers are in `/usr/local/include` and libraries are in `/usr/local/lib`)
