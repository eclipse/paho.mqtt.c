...
Paho MQTT C supports two building systems, Autotools and CMake.
...
The distribuition target generates a tarball suitable to building on systems where Autotools isn't installed. In order to do so, you must generate a distribuition package on a system with Autotools installed:
